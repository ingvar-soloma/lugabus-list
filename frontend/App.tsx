...
const MethodologyPage = () => (
  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-12 py-10">
    <h1 className="text-6xl font-black tracking-tighter uppercase mb-10 italic">Методологія<span className="text-emerald-500">.ua</span></h1>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
      <div className="glass p-8 rounded-[2.5rem] border-white/5">
        <h3 className="text-xl font-black uppercase tracking-tight mb-4 text-emerald-500 italic">01. Джерела даних</h3>
        <p className="text-zinc-400 leading-relaxed font-medium">Ми приймаємо лише прямі посилання на відео, офіційні документи або верифіковані дописи у соціальних мережах. Посилання на анонімні Telegram-канали без додаткових доказів не розглядаються.</p>
      </div>
      <div className="glass p-8 rounded-[2.5rem] border-white/5">
        <h3 className="text-xl font-black uppercase tracking-tight mb-4 text-emerald-500 italic">02. Процес верифікації</h3>
        <p className="text-zinc-400 leading-relaxed font-medium">Кожен запропонований пруф проходить три стадії: автоматичний ШІ-аналіз тональності, перевірка модератором та публічне голосування спільноти (Feedback Loop).</p>
      </div>
    </div>
  </motion.div>
);
...
const ContactPage = () => (
  <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-2xl mx-auto py-10">
    <h1 className="text-6xl font-black tracking-tighter uppercase mb-10 text-center italic">Контакти<span className="text-emerald-500">.ua</span></h1>
