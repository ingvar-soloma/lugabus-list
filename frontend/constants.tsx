...
export const MOCK_ADMIN_USERS: User[] = [
  MOCK_USER,
  { id: 'u-2', username: 'Moderator_Kyiv', role: UserRole.MODERATOR, avatar: 'https://picsum.photos/seed/u2/100/100', email: 'mod1@lugabus.ua', createdAt: '2023-03-12', submissionsCount: 12 },
  { id: 'u-3', username: 'Citizen_X', role: UserRole.USER, avatar: 'https://picsum.photos/seed/u3/100/100', email: 'user123@gmail.com', createdAt: '2023-05-20', submissionsCount: 3 },
  { id: 'u-4', username: 'Patriot_UA', role: UserRole.USER, avatar: 'https://picsum.photos/seed/u4/100/100', email: 'ua_forever@ukr.net', createdAt: '2023-06-15', submissionsCount: 45 },
];
...
export const MOCK_PEOPLE: Person[] = [
  {
    ...
    proofs: [
      { id: 'pr-1', text: 'Заява на ефірі каналу Х про необхідність капітуляції.', sourceUrl: '#', date: '2023-09-12', likes: 120, dislikes: 5, status: 'APPROVED', submittedBy: 'u-3' }
    ],
    history: [
  ...
  },
  {
    ...
    proofs: [
      { id: 'pr-2', text: 'Звіт про передачу 100 дронів 3-й штурмовій.', sourceUrl: '#', date: '2023-10-18', likes: 450, dislikes: 2, status: 'APPROVED', submittedBy: 'u-4' }
    ],
    history: [
  ...
  },
  {
    ...
    proofs: [
      { id: 'pr-3', text: 'Помічений на концерті в Дубаї під час обстрілів.', sourceUrl: '#', date: '2023-01-10', likes: 50, dislikes: 80, status: 'APPROVED', submittedBy: 'u-3' }
    ],
    history: [
