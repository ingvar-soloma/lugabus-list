...
### 🗄️ Фаза 1: Розширена Data-схема & Core
...
### 🕵️ Фаза 2: Privacy, Security & Viral
...
- [ ] **Logic: Детектор "Перевзування" (Consistency Tracker)**
  - [ ] Порівняння архівних цитат з поточними позиціями
  - [ ] Маркер "Визнав помилку" vs "Тихе перевзування"
- [ ] **Graph: Візуалізація позицій та зв'язків**
  - [ ] Таймлайн зміни поглядів особи (Timeline View)
...
### 📢 Фаза 4: Публічність та Безсмертя. Волонтери, Збори та Публічність

- [ ] **Module: Моніторинг зборів**
  - [ ] Трекінг банок (Monobank API/Scraping)
  - [ ] Співвідношення звітність/сума збору
