...
- [ ] **Anti-Abuse: Shadow Ban Logic** (Приховані обмеження для низької репутації)
- [ ] **Anti-Abuse: Progressive Tracking** (Логування IP лише при порушеннях)
...
- [ ] **Viral: Модуль "Поділитися"** (Priority)
  - [ ] Генерація OG-зображень (карток) для соцмереж з досьє
